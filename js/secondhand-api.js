...
(function(window) {
    ...
    var fullProducts = [
        // ---- 数码 ----
        { id:1, name:'宿舍床上小书桌（适合追剧/上网课）', category:'生活用品', price:29, originalPrice:59, condition:'8成新', desc:'折叠床上小书桌，可调节角度，追剧上网课神器，稳固不晃，宿舍必备好物。', seller:'大一新生', sellerDept:'计算机学院', sellerPhone:'138****5678', sellerAvatar:'https://i.pravatar.cc/80?img=11', views:348, likes:89, collects:32, location:'东区宿舍', time:'2026-06-10 08:30', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },
        { id:2, name:'蓝牙音箱迷你款', category:'数码', price:39, originalPrice:99, condition:'9成新', desc:'迷你蓝牙音箱，小巧便携，音质不错，宿舍听歌看剧都好用。', seller:'小李', sellerDept:'电子信息学院', sellerPhone:'139****5678', sellerAvatar:'https://i.pravatar.cc/80?img=12', views:156, likes:45, collects:19, location:'南区宿舍', time:'2026-06-10 10:15', status:'在售', tag:'new', comments:[], reviewStatus:'approved', stock:1 },
        { id:3, name:'64G U盘两个装', category:'数码', price:25, originalPrice:60, condition:'全新', desc:'全新金士顿64G U盘两个，USB3.0接口，存课件资料必备，毕业清仓。', seller:'考研党', sellerDept:'文学与传媒学院', sellerPhone:'137****1234', sellerAvatar:'https://i.pravatar.cc/80?img=13', views:189, likes:52, collects:21, location:'南区宿舍', time:'2026-06-09 14:20', status:'在售', tag:'rec', comments:[], reviewStatus:'approved', stock:1 },
        { id:4, name:'手机支架桌面款', category:'数码', price:15, originalPrice:39, condition:'9成新', desc:'铝合金手机支架，可调角度，桌面追剧视频通话神器。', seller:'音乐人', sellerDept:'艺术设计学院', sellerPhone:'135****9012', sellerAvatar:'https://i.pravatar.cc/80?img=14', views:198, likes:56, collects:23, location:'北区宿舍', time:'2026-06-09 16:00', status:'在售', tag:'new', comments:[], reviewStatus:'approved', stock:1 },
        { id:5, name:'大学物理+高数教材带笔记', category:'书籍', price:15, originalPrice:45, condition:'有笔记', desc:'大学物理上下册+高等数学同济版，含课堂重点笔记和习题解答，理工科必备。', seller:'已上岸', sellerDept:'数学与统计学院', sellerPhone:'131****4567', sellerAvatar:'https://i.pravatar.cc/80?img=15', views:313, likes:89, collects:36, location:'北区宿舍', time:'2026-06-08 09:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },
        { id:6, name:'罗技G502有线鼠标', category:'数码', price:199, originalPrice:399, condition:'9成新', desc:'罗技G502游戏鼠标，11个可编程按键，配重可调，使用半年。', seller:'电竞选手', sellerDept:'计算机学院', sellerPhone:'138****9900', sellerAvatar:'https://i.pravatar.cc/80?img=16', views:78, likes:22, collects:9, location:'西区宿舍', time:'2026-06-10 07:45', status:'在售', tag:'new', comments:[], reviewStatus:'approved', stock:1 },
        { id:7, name:'鼠标垫超大号', category:'数码', price:19, originalPrice:49, condition:'9成新', desc:'900x400mm超大鼠标垫，桌面全覆盖，防滑底面，游戏办公都好用。', seller:'游戏玩家', sellerDept:'计算机学院', sellerPhone:'133****6789', sellerAvatar:'https://i.pravatar.cc/80?img=17', views:189, likes:56, collects:20, location:'西区宿舍', time:'2026-06-07 20:30', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:8, name:'小米充电宝20000mAh', category:'数码', price:59, originalPrice:129, condition:'9成新', desc:'小米移动电源2，20000mAh大容量，双USB输出，可充手机3-4次。', seller:'毕业清仓', sellerDept:'物理与电子学院', sellerPhone:'136****1100', sellerAvatar:'https://i.pravatar.cc/80?img=18', views:92, likes:18, collects:7, location:'东区宿舍', time:'2026-06-10 11:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:9, name:'U盘128G 金士顿', category:'数码', price:35, originalPrice:79, condition:'全新', desc:'全新未拆封，金士顿DT100G3 128GB USB3.0，存课件资料必备。', seller:'数码达人', sellerDept:'计算机学院', sellerPhone:'135****2200', sellerAvatar:'https://i.pravatar.cc/80?img=19', views:45, likes:10, collects:4, location:'教学楼', time:'2026-06-10 09:30', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:10, name:'平板支架铝合金', category:'数码', price:25, originalPrice:69, condition:'9成新', desc:'铝合金折叠支架，适配iPad/平板，可调角度，桌面追剧神器。', seller:'追剧党', sellerDept:'外国语学院', sellerPhone:'134****3300', sellerAvatar:'https://i.pravatar.cc/80?img=20', views:63, likes:14, collects:5, location:'南区宿舍', time:'2026-06-09 18:00', status:'已售出', tag:'', comments:[], reviewStatus:'approved', stock:0 },

        // ---- 书籍 ----
        { id:11, name:'考研英语真题全套', category:'书籍', price:50, originalPrice:200, condition:'有笔记', desc:'考研英语全套复习资料，含真题、模拟题、词汇书。已上岸，资料上有重点标注和笔记。', seller:'已上岸', sellerDept:'外国语学院', sellerPhone:'136****5678', sellerAvatar:'https://i.pravatar.cc/80?img=21', views:312, likes:89, collects:45, location:'图书馆', time:'2026-06-10 06:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },
        { id:12, name:'高等数学教材上下册', category:'书籍', price:30, originalPrice:68, condition:'9成新', desc:'同济大学第七版，无笔记，保存完好，理工科必备。', seller:'学长', sellerDept:'数学与统计学院', sellerPhone:'134****2345', sellerAvatar:'https://i.pravatar.cc/80?img=22', views:45, likes:8, collects:3, location:'教学楼', time:'2026-06-08 12:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:13, name:'C语言程序设计谭浩强', category:'书籍', price:25, originalPrice:49, condition:'9成新', desc:'经典教材，无笔记，适合计算机专业入门学习。', seller:'计算机系', sellerDept:'计算机学院', sellerPhone:'128****6789', sellerAvatar:'https://i.pravatar.cc/80?img=23', views:112, likes:28, collects:10, location:'教学楼', time:'2026-06-07 09:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:14, name:'大学英语四级真题+词汇', category:'书籍', price:20, originalPrice:80, condition:'有笔记', desc:'近五年四级真题，含听力光盘和词汇手册，已过级转让。重点词汇已标注。', seller:'过级达人', sellerDept:'外国语学院', sellerPhone:'137****8800', sellerAvatar:'https://i.pravatar.cc/80?img=24', views:178, likes:42, collects:18, location:'南区宿舍', time:'2026-06-09 10:00', status:'在售', tag:'rec', comments:[], reviewStatus:'approved', stock:1 },
        { id:15, name:'数据结构教材（C语言版）', category:'书籍', price:28, originalPrice:55, condition:'8成新', desc:'严蔚敏版数据结构，含课堂笔记和习题答案，期末复习利器。', seller:'软工学长', sellerDept:'计算机学院', sellerPhone:'136****4400', sellerAvatar:'https://i.pravatar.cc/80?img=25', views:95, likes:25, collects:11, location:'教学楼', time:'2026-06-06 15:00', status:'已售出', tag:'', comments:[], reviewStatus:'approved', stock:0 },
        { id:16, name:'考研政治全套资料', category:'书籍', price:35, originalPrice:150, condition:'有笔记', desc:'肖秀荣全套+徐涛核心考案，2026考研用，已上岸。重点已划线。', seller:'考研上岸', sellerDept:'法学院', sellerPhone:'135****5500', sellerAvatar:'https://i.pravatar.cc/80?img=26', views:256, likes:78, collects:35, location:'北区宿舍', time:'2026-06-10 05:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },

        // ---- 生活用品 ----
        { id:17, name:'小米台灯Pro', category:'生活用品', price:60, originalPrice:179, condition:'9成新', desc:'小米智能台灯Pro，支持小爱同学控制，色温亮度可调，护眼模式。', seller:'小米粉', sellerDept:'物理与电子学院', sellerPhone:'134****3456', sellerAvatar:'https://i.pravatar.cc/80?img=27', views:89, likes:23, collects:8, location:'西区宿舍', time:'2026-06-09 08:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:18, name:'膳魔师保温杯500ml', category:'生活用品', price:45, originalPrice:199, condition:'9成新', desc:'膳魔师保温杯，500ml，保温效果好，无异味。', seller:'闲置转让', sellerDept:'法学院', sellerPhone:'130****8901', sellerAvatar:'https://i.pravatar.cc/80?img=28', views:78, likes:15, collects:6, location:'食堂门口', time:'2026-06-07 11:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:19, name:'宿舍收纳箱3件套', category:'生活用品', price:35, originalPrice:89, condition:'8成新', desc:'三个不同尺寸收纳箱，可叠放，毕业清仓。', seller:'毕业生', sellerDept:'经济管理学院', sellerPhone:'129****6600', sellerAvatar:'https://i.pravatar.cc/80?img=29', views:67, likes:12, collects:5, location:'北区宿舍', time:'2026-06-08 16:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:20, name:'宿舍遮光床帘', category:'生活用品', price:35, originalPrice:79, condition:'9成新', desc:'遮光床帘，1.2m床铺适用，防尘遮光，宿舍隐私好物。', seller:'毕业生', sellerDept:'经济管理学院', sellerPhone:'125****8901', sellerAvatar:'https://i.pravatar.cc/80?img=30', views:98, likes:23, collects:9, location:'北区宿舍', time:'2026-06-06 14:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:21, name:'暖壶热水瓶2L', category:'生活用品', price:15, originalPrice:39, condition:'9成新', desc:'不锈钢内胆暖壶，2L容量，保温24小时，宿舍必备。', seller:'生活达人', sellerDept:'化学学院', sellerPhone:'128****7700', sellerAvatar:'https://i.pravatar.cc/80?img=31', views:34, likes:6, collects:2, location:'东区宿舍', time:'2026-06-10 12:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },

        // ---- 运动器材 ----
        { id:22, name:'羽毛球拍套装', category:'运动', price:180, originalPrice:350, condition:'9成新', desc:'尤尼克斯羽毛球拍，送球和球包，使用半年。', seller:'运动达人', sellerDept:'体育学院', sellerPhone:'135****7890', sellerAvatar:'https://i.pravatar.cc/80?img=32', views:67, likes:12, collects:5, location:'体育馆', time:'2026-06-09 07:00', status:'在售', tag:'rec', comments:[], reviewStatus:'approved', stock:1 },
        { id:23, name:'斯伯丁篮球', category:'运动', price:120, originalPrice:259, condition:'8成新', desc:'室外用球，手感好，适合日常运动，气嘴无漏气。', seller:'体育生', sellerDept:'体育学院', sellerPhone:'129****2345', sellerAvatar:'https://i.pravatar.cc/80?img=33', views:234, likes:45, collects:18, location:'操场', time:'2026-06-07 18:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:24, name:'瑜伽垫加厚款', category:'运动', price:35, originalPrice:89, condition:'9成新', desc:'加厚10mm，防滑，带收纳袋，适合健身瑜伽。', seller:'健身达人', sellerDept:'体育学院', sellerPhone:'122****0123', sellerAvatar:'https://i.pravatar.cc/80?img=34', views:45, likes:8, collects:3, location:'体育馆', time:'2026-06-06 10:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:25, name:'跳绳计数款', category:'运动', price:15, originalPrice:35, condition:'9成新', desc:'钢丝绳芯，计数手柄，适合日常锻炼和体测。', seller:'健身族', sellerDept:'体育学院', sellerPhone:'121****8800', sellerAvatar:'https://i.pravatar.cc/80?img=35', views:28, likes:5, collects:2, location:'操场', time:'2026-06-10 13:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:26, name:'有线耳机（适用于电脑/手机）', category:'数码', price:39, originalPrice:129, condition:'9成新', desc:'3.5mm接口有线耳机，音质清晰，带麦克风，适用于电脑网课和手机听歌，线材柔软不易缠绕。', seller:'追剧党', sellerDept:'外国语学院', sellerPhone:'132****0123', sellerAvatar:'https://i.pravatar.cc/80?img=36', views:247, likes:67, collects:22, location:'南区宿舍', time:'2026-06-05 09:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },

        // ---- 实训工具 ----
        { id:27, name:'电烙铁焊接套装', category:'实训工具', price:35, originalPrice:89, condition:'9成新', desc:'含焊锡丝、吸锡器等配件，适合电子实训使用。', seller:'电子系学长', sellerDept:'电子信息学院', sellerPhone:'127****0123', sellerAvatar:'https://i.pravatar.cc/80?img=37', views:56, likes:12, collects:4, location:'实训楼', time:'2026-06-06 08:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:28, name:'万用表数字式', category:'实训工具', price:55, originalPrice:128, condition:'9成新', desc:'优利德数字万用表，功能完好，适合电工实训。', seller:'电气系', sellerDept:'电子信息学院', sellerPhone:'124****2345', sellerAvatar:'https://i.pravatar.cc/80?img=38', views:67, likes:15, collects:5, location:'实训楼', time:'2026-06-05 14:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },

        // ---- 小家电 ----
        { id:29, name:'宿舍静音小风扇', category:'小家电', price:25, originalPrice:49, condition:'9成新', desc:'USB供电静音小风扇，3档风力可调，噪音极低，宿舍夏天必备，不影响室友休息。', seller:'宿舍达人', sellerDept:'物理与电子学院', sellerPhone:'126****4567', sellerAvatar:'https://i.pravatar.cc/80?img=39', views:257, likes:78, collects:30, location:'南区宿舍', time:'2026-06-04 10:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },
        { id:30, name:'USB小夜灯', category:'小家电', price:12, originalPrice:29, condition:'9成新', desc:'USB供电小夜灯，三档调光，柔和不刺眼，宿舍熬夜必备。', seller:'夜猫子', sellerDept:'计算机学院', sellerPhone:'123****6789', sellerAvatar:'https://i.pravatar.cc/80?img=40', views:134, likes:34, collects:14, location:'东区宿舍', time:'2026-06-04 16:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },
        { id:31, name:'美的电热水壶1.5L', category:'小家电', price:30, originalPrice:89, condition:'9成新', desc:'不锈钢内胆，自动断电，烧水快，宿舍用。', seller:'生活管家', sellerDept:'化学学院', sellerPhone:'122****9900', sellerAvatar:'https://i.pravatar.cc/80?img=41', views:52, likes:11, collects:4, location:'西区宿舍', time:'2026-06-09 20:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 },

        // ---- 其他 ----
        { id:32, name:'考研资料+笔记整理', category:'其他', price:45, originalPrice:200, condition:'有笔记', desc:'计算机考研全套资料，含408真题、笔记、思维导图，已上岸。', seller:'408上岸', sellerDept:'计算机学院', sellerPhone:'121****1000', sellerAvatar:'https://i.pravatar.cc/80?img=42', views:201, likes:65, collects:28, location:'北区宿舍', time:'2026-06-10 04:00', status:'在售', tag:'hot', comments:[], reviewStatus:'approved', stock:1 },
        { id:33, name:'小熊煮蛋器', category:'小家电', price:20, originalPrice:59, condition:'9成新', desc:'小熊煮蛋器，一次可煮6个，自动断电，早餐神器。', seller:'美食家', sellerDept:'食品学院', sellerPhone:'120****2000', sellerAvatar:'https://i.pravatar.cc/80?img=43', views:41, likes:9, collects:3, location:'南区宿舍', time:'2026-06-08 19:00', status:'在售', tag:'', comments:[], reviewStatus:'approved', stock:1 }
    ];
