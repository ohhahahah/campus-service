...
(function() {
    ...
    var navigationMap = [
        ...
        { keys: ['报修', '维修', '故障', '宿舍报修', '工单', '水电报修'], url: 'repair.html', label: '宿舍报修', icon: 'fas fa-tools', desc: '提交宿舍报修工单' },
        ...
        { keys: ['宿舍', '寝室', '宿舍服务', '住宿'], url: 'dormitory.html', label: '宿舍服务', icon: 'fas fa-bed', desc: '宿舍相关信息' },
    ...
    var quickQuestions = ['首页导航', '二手交易', '生活服务', '场馆预约', '兼职互助', '流浪猫寄养', '宿舍报修'];
    ...
    function getReply(text) {
        ...
        if (/生活|服务|餐饮|食堂|快递|报修|电信|校医|商城/.test(lower)) return knowledgeBase['生活服务'];
